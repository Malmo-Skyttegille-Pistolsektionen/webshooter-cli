...
class SignupsCommand(BaseCommand):
    ...
    @staticmethod
    def get_signups(competition_id: int, club: str, card: int) -> None:
        ...
        signup_data_map = SignupsCommand._aggregate_signup_data(signups, signups_by_card, club, card)

        # Count weapon class distribution
        counter_all, counter_club = SignupsCommand._count_weapon_classes(signups, club, card)

        # Display results
        SignupsCommand._display_signup_table(signup_data_map)
        BaseCommand.print_section_separator()
        SignupsCommand._display_stats_table(counter_all, counter_club, club)
    ...
    @staticmethod
    def _count_weapon_classes(signups: List[Signup], club: str, card: int) -> tuple[Dict[str, int], Dict[str, int]]:
