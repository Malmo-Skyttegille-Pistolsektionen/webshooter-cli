"""Display start times for a competition command."""
...
from webshooter_client.common.output_utils import print_competition_header, matches_club_and_card, print_table


def get_starttimes(competition_id: int, club: str, card: Optional[str] = None) -> None:
    """Display start times for a competition filtered by club/card.
